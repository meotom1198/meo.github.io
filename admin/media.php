            ...
            <div class="col-mb-12 col-tb-8" role="main">
                ...
                <div id="upload-panel" class="p">
                    <div class="upload-area"
                         draggable="true"><?php _e('Kéo và thả tệp vào đây<br>hoặc %s chọn tệp tải lên%s', '<a href="###" class="upload-file">', '</a>'); ?></div>
                    <ul id="file-list"></ul>
                </div>
            </div>
    ...
    $(document).ready(function () {
        ...
        function fileUploadError(error) {
            ...
            switch (code) {
                ...
                case plupload.FILE_EXTENSION_ERROR:
                    word = '<?php _e('Định dạng tập tin không được hỗ trợ'); ?>';
                    break;
                ...
                default:
                    word = '<?php _e('Tập tin đã được tải lên'); ?>';
                    break;
            }

            var fileError = '<?php _e('Không thể tải lên %s'); ?>'.replace('%s', file.name),
                li, exist = $('#' + file.id);
        ...
        var uploader = new plupload.Uploader({
            ...
            filters: {
                ...
                mime_types: [{
                    'title': '<?php _e('Các tập tin được phép tải lên'); ?>',
