...
<div id="comments">
    ...
    <?php if ($comments->have()): ?>
        <h3><?php $this->commentsNum(_t('Chua có bình luận'), _t('Có một bình luận'), _t('Có %d bình luận')); ?></h3>
    ...
    <?php if ($this->allow('comment')): ?>
        <div id="<?php $this->respondId(); ?>" class="respond">
            ...
            <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
                ...
                <?php else: ?>
                    <p>
                        <label for="author" class="required"><?php _e('Lời chào'); ?></label>
