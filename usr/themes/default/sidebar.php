...
<div class="col-mb-12 col-offset-1 col-3 kit-hidden-tb" id="secondary" role="complementary">
    ...
    <?php if (!empty($this->options->sidebarBlock) && in_array('ShowRecentComments', $this->options->sidebarBlock)): ?>
        <section class="widget">
            <h3 class="widget-title"><?php _e('Trả lời gần đây'); ?></h3>
            <ul class="widget-list">
    ...
    <?php if (!empty($this->options->sidebarBlock) && in_array('ShowCategory', $this->options->sidebarBlock)): ?>
        <section class="widget">
            <h3 class="widget-title"><?php _e('Chuyên mục'); ?></h3>
        ...
        <section class="widget">
            ...
            <ul class="widget-list">
                <?php if ($this->user->hasLogin()): ?>
                    <li class="last"><a href="<?php $this->options->adminUrl(); ?>"><?php _e('Trang quản trị'); ?>
                ...
                <li><a href="<?php $this->options->commentsFeedUrl(); ?>"><?php _e('Nhận xét RSS'); ?></a></li>
