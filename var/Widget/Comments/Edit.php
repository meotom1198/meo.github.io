...
class Edit extends Comments implements ActionInterface
{
    ...
    public function waitingComment()
    {
        ...
        Notice::alloc()
            ->set(
                $updateRows > 0 ? _t('Bình luận đã được đánh dấu để kiểm duyệt') : _t('Không có ý kiến ​​​​được đánh dấu để kiểm duyệt'),
    ...
    public function spamComment()
    {
        ...
        Notice::alloc()
            ->set(
                $updateRows > 0 ? _t('Bình luận đã được đánh dấu là spam') : _t('Không có bình luận nào bị đánh dấu là spam'),
                $updateRows > 0 ? 'success' : 'notice'
            );
    ...
    public function approvedComment()
    {
        ...
        Notice::alloc()
            ->set(
                $updateRows > 0 ? _t('Bình luận đã được kiểm duyệt') : _t('Không có bình luận nào được kiểm duyệt'),
                $updateRows > 0 ? 'success' : 'notice'
            );
    ...
    public function deleteComment()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            Notice::alloc()
                ->set(
                    $deleteRows > 0 ? _t('Bình luận đã bị xóa') : _t('Không có bình luận nào'),
    ...
    public function deleteSpamComment()
    {
        ...
        /** 设置提示信息 */
        Notice::alloc()->set(
            $deleteRows > 0 ? _t('Tất cả các bình luận spam đã bị xóa') : _t('Không có bình luận nào'),
            $deleteRows > 0 ? 'success' : 'notice'
        );
    ...
    public function replyComment()
    {
        ...
        $this->response->throwJson([
            'success' => 0,
            'message' => _t('Không thể trả lời bình luận')
        ]);
    }
