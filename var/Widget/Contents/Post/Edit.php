...
class Edit extends Contents implements ActionInterface
{
    ...
    public function writePost()
    {
        ...
        if ($this->request->is('do=publish')) {
            ...
            Notice::alloc()->set('post' == $this->type ?
                ...
                _t('Bài viết "%s" đang chờ kiểm duyệt', $this->title), 'success');
    ...
    public function markPost()
    {
        ...
        Notice::alloc()
            ->set(
                $markCount > 0 ? _t('Bài viết đã được đánh dấu là <strong>%s</strong>', $statusList[$status]) : _t('Không có bài viết nào được gắn cờ'),
    ...
    public function deletePost()
    {
        ...
        /** 设置提示信息 */
        Notice::alloc()->set(
            $deleteCount > 0 ? _t('Bài viết đã bị xóa') : _t('Không có bài viết đã bị xóa'),
